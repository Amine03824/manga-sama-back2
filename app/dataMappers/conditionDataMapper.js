...
const conditionDataMapper = {
  ...
  findAllConditions: async () => {
    const sql = "SELECT * FROM condition ORDER BY title ASC";
  ...
  insertOneCondition: async ({
    ...
    const sql = {
      text: "INSERT INTO condition (id, title, description, price, transaction_id, date_transaction, state_completion, image_url, condition_id) VALUES ($1, $2, $3, $4, $5, $6, $7, $8, $9) RETURNING *;",
      values: [
        id,
        condition_name
      ]
